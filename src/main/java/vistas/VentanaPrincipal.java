...
public class VentanaPrincipal extends javax.swing.JFrame implements miInterfaceCon {
    ...
    private void initComponents() {
        ...
        meActualizar = new javax.swing.JMenuItem();
        ...
        meActualizar.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F5, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        meActualizar.setText("Guardar");
        meActualizar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                meActualizarActionPerformed(evt);
            }
        });
        jMenu13.add(meActualizar);
    ...
    private void meActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_meActualizarActionPerformed

          miInterface ve = getCurrentWindow();
        if (ve == null) {
            return;
        }
        ve.imActualizar(); //lo unico que cambia en los otros es esta parte
        
    }//GEN-LAST:event_meActualizarActionPerformed
...
// TODO add your handling code here:
    ...
    private javax.swing.JMenuItem meActualizar;
